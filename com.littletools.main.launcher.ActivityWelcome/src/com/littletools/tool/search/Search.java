...
public class Search {
	...
	private static final String HTTP_URL = "http://www.kuaidi100.com/openapi/";//"http://api.kuaidi100.com/apione";
	
	private static final String PARAM_NAME_COMPANY= "com"; //公司代码
	
	private static final String PARAM_NAME_ORDER = "nu"; //订单�?
	
	private static final String PARAM_NAME_RETURN = "show"; //返回值的类型�?，json�?，xml�?
	
	private static final String METHOD = "GET";
	
	/**
	 * 
	 * @param companyCode：公司代�?
	 * @param order:订单�?
	 * @return
	 */
	public String request(String companyCode, String order){
		...
		params.putString(PARAM_NAME_RETURN, "0"); //采用json返回值类�?
